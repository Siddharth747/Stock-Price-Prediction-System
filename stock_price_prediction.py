...
Original file is located at
    https://colab.research.google.com/drive/1NgPBR9YP66aFAgRaLFtV4Jm7ZnDI5hT6
"""
...
# plt.plot(df.index[train_size+look_back:], df['Close'][train_size+look_back:], label='Actual')
# plt.plot(df.index[train_size+look_back:], predictions, label='Predicted')
# plt.legend()
# plt.show()
...
# test_data = data[int(data_len * 0.8):]
...
#         x_data.append(data[i-seq_len:i, 0])
#         y_data.append(data[i, 0])
#     return np.array(x_data), np.array(y_data)

# # Create the training dataset
# seq_len = 60
# train_x, train_y = create_dataset(scaled_train_data, seq_len)

# # Create the testing dataset
# test_x, test_y = create_dataset(scaled_test_data, seq_len)
...
"""**Now we look at stock prices of several different MNCs**
...
# Relation with itself should be linear for each stock
sns.jointplot(x='GOOG', y='GOOG', data=tech_rets, kind='scatter', color='seagreen')

# Relative Comparison
sns.jointplot(x='GOOG', y='MSFT', data=tech_rets, kind='scatter')

# Relative Comparison for all

sns.pairplot(tech_rets, kind='reg')

return_fig = sns.PairGrid(tech_rets.dropna())

# Upper triangle color change
return_fig.map_upper(plt.scatter, color='purple')

# Lower triangle color theme
